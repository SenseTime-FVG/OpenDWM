...
from Initialization.Standardimport.agents.navigation.local_planner import LocalPlanner, RoadOption
from Initialization.Standardimport.agents.navigation.global_route_planner import GlobalRoutePlanner
from Initialization.Standardimport.agents.tools.misc import (get_speed, is_within_distance, get_trafficlight_trigger_location, compute_distance)
...
class BasicAgent(object):
    ...
    def set_global_plan(self, plan, stop_waypoint_creation=True, clean_queue=True):
        ...
        """
        for wp in plan:
            self._world.debug.draw_point(wp[0].transform.location, size=0.1, color=carla.Color(0, 0, 255), life_time=120.0)
