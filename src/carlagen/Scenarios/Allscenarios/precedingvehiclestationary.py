...
from Initialization.Standardimport.scenariomanager.scenarioatomics.atomic_trigger_conditions import (DriveDistance, StandStill,InTriggerDistanceToVehicle)
...
class PrecedingVehicleStationary(BasicScenario):
    ...
    def _initialize_actors(self, config):
        ...
        # For: 在自车前方50米生成一辆车
        first_vehicle_wp = move_waypoint_forward(self.starting_wp, random.randint(60, 70))
