...
class MountainRoad(BasicScenario):
    """
    Desc: TODO
    Special: 补充TODO的数据
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super().__init__("MountainRoad", ego_vehicles, config, world, randomize, debug_mode,
    ...
    def _create_behavior(self):
        root = py_trees.composites.Parallel(name="MountainRoad",
                                            policy=py_trees.common.ParallelPolicy.SUCCESS_ON_ONE)
        c1 = py_trees.composites.Sequence(name="MountainRoad_c1")
        c1.add_child(InTriggerDistanceToNextIntersection(self.ego_vehicles[0], 55))
        root.add_child(c1)
        return root
